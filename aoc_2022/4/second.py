...
with open('input', 'r') as c:
	...
	for line in lines:
		...
		if (first_elf_first_zone <= second_elf_first_zone and first_elf_second_zone >= second_elf_first_zone) or (second_elf_first_zone <= first_elf_first_zone and second_elf_second_zone >= first_elf_first_zone):
			score+=1
